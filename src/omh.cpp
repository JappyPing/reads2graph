/*
The follwoing source codes is from the implementatation of the Order Min Hash (OMH)(https://github.com/Kingsford-Group/omhismb2019). If you want to use the following source codes in your project, please remember to cite the original work listed below.
