...
int main(int argc, char** argv) {
    ...
    args.uni_reads_num = unique_reads.size();

    Utils::getInstance().logger(LOG_LEVEL_INFO, boost::str(boost::format("The number of unique reads: %1%, minimum read length: %2%.") % args.uni_reads_num % args.read_length));
